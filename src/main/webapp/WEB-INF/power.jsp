                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="powerSwitch" checked onclick="confirmPower()">
                                        <label class="form-check-label" for="powerSwitch">기기 전원 켜기/끄기</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label" for="valveSwitch">배관 밸브 열기/닫기</label>
                                    </div>
                                </div>
                            </div>
                        </div>
