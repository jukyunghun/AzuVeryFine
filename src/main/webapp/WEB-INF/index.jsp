                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-body"><canvas id="realtimeChart" width="100%" height="40"></canvas></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-body"><canvas id="graph3" width="100%" height="40"></canvas></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-body"><canvas id="graph4" width="100%" height="40"></canvas></div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card mb-4">
                                ...
                                <div class="card-body"><canvas id="graph5" width="100%" height="40"></canvas></div>
                            </div>
                        </div>
                    </div>
                </div>
