                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>활성</td>
                                                <td><button class="btn btn-danger" onclick="toggleConnection(this)">연결 해제</button></td>
                                            </tr>
                                            <tr>
                                                <td>디바이스 2</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>비활성</td>
                                                <td><button class="btn btn-success" onclick="toggleConnection(this)">연결</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
